package pqt.dss.accOpening.view.bb;
...
public class aclDetailClass {
    private RichTable t1;
    private RichInputText it2;
    private RichInputText it1;
    private RichInputDate id1;
    private RichInputListOfValues userBranchNameId;
    ...
    public void setUserBranchNameId(RichInputListOfValues userBranchNameId) {
        this.userBranchNameId = userBranchNameId;
    }

    public RichInputListOfValues getUserBranchNameId() {
        return userBranchNameId;
    }
    ...
    public String Branch_action() {
        ...
        operation.getParamsMap().put("p_document_id", getAttributeValue("AccOpenHdrIdPk"));
    ...
    public String SubmitForApproval() {
        // Add event code here...
        BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
        OperationBinding operation = bindings.getOperationBinding("callAccOpenWorkflow");
        operation.getParamsMap().put("p_document_id", getAttributeValue("AccOpenHdrIdPk"));
        operation.execute();
